...
export const BASE_DICTIONARIES: Record<string, Record<string, string>> = { en, es, pt }
...
export const LOCALE_LABELS: Record<string, string> = { en: 'English', es: 'Español', pt: 'Português' }

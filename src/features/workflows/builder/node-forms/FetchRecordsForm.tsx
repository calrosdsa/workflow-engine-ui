...
export function FetchRecordsForm({ config, variables, nodeContext, onChange }: FetchRecordsFormProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Mode */}
      <div className="space-y-1.5">
        <Label className="text-[11px] font-semibold uppercase tracking-wider text-[hsl(var(--muted-foreground))]">Retrieve</Label>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            ...
            <Label className="text-[11px] font-semibold uppercase tracking-wider text-[hsl(var(--muted-foreground))]">Sort</Label>
          </div>
      ...
      {/* Limit */}
      <div className="space-y-1.5">
        <Label className="text-[11px] font-semibold uppercase tracking-wider text-[hsl(var(--muted-foreground))]">Limit</Label>
        <div className="flex items-center gap-1.5">
          <Input
            type="number"
            min={0}

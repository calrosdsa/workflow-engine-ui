...
export function RichTextConfigPanel({ config, onChange }: WidgetConfigPanelProps<RichTextWidgetConfig>) {
  return (
    <div className="space-y-1.5">
      <Label className="text-[11px] font-medium text-[hsl(var(--muted-foreground))]">Markdown</Label>
      <Textarea
      ...
      />
      <p className="text-[10px] text-[hsl(var(--muted-foreground))]">Supports headings, bold/italic, links, lists, and blockquotes.</p>
    </div>
  )
}

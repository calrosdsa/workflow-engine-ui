...
// a duplicate type, not a silent overwrite), but this file must be imported
// exactly once, as early as possible (before any component reads the
// registry) — see widget-registry.ts's load-order note.
import './heading'
import './paragraph'
import './richtext'
import './image'

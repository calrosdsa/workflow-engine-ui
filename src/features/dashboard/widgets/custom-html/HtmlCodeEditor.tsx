    ...
    const view = new EditorView({
      state: EditorState.create({
        ...
        extensions: [
          ...
          EditorView.theme({
            '&': { fontSize: '12px', borderRadius: '8px', border: '1px solid hsl(var(--border))', backgroundColor: 'hsl(var(--card))', overflow: 'hidden' },
            '.cm-content': { fontFamily: "'Fira Mono', 'Cascadia Code', 'Consolas', monospace", padding: '10px 4px', minHeight: '220px', caretColor: 'hsl(var(--primary))' },
